...
@Component({
  selector: 'app-riu-buenavista',
  templateUrl: './riu-buenavista.component.html',
  styleUrls: ['./riu-buenavista.component.css']
})
export class RiuBuenavistaComponent implements OnInit {

  reserva = {
    nombre_hotel: "RIU Buenavista ★★★★",
    tipo_habitacion: "",
    numero_huespedes: "",
    fecha_entrada: "",
    fecha_salida: ""
