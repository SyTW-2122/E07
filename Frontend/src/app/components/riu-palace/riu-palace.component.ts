...
@Component({
  selector: 'app-riu-palace',
  templateUrl: './riu-palace.component.html',
  styleUrls: ['./riu-palace.component.css']
})
export class RiuPalaceComponent implements OnInit {

  reserva = {
    nombre_hotel: "RIU Palace ★★★★★",
    tipo_habitacion: "",
    numero_huespedes: "",
    fecha_entrada: "",
    fecha_salida: ""
