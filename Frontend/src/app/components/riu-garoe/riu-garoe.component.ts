...
@Component({
  selector: 'app-riu-garoe',
  templateUrl: './riu-garoe.component.html',
  styleUrls: ['./riu-garoe.component.css']
})
export class RiuGaroeComponent implements OnInit {

  reserva = {
    nombre_hotel: "RIU Garoe ★★★★",
    tipo_habitacion: "",
    numero_huespedes: "",
    fecha_entrada: "",
    fecha_salida: ""
